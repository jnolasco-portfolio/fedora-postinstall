...
# https://git.furworks.de/tobias/fedora-install
# https://www.forbes.com/sites/jasonevangelho/2019/03/05/new-fedora-linux-user-run-this-amazing-post-install-script-first/#1ec9d2d2915b
# http://blog.brunomiguel.net/geekices/things-to-do-after-installing-fedora/
